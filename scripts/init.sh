...
echo "2. For published images, run 'docker compose -f docker-compose.prod.yml pull'"
echo "3. Run 'docker compose -f docker-compose.prod.yml up -d' to start the services"
