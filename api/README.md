...
read-only; it cannot invoke actor-only lifecycle commands or decrypt management write replies. Read replies pass through in plaintext.
...
[the operations runbook](../docs/operations.md) and [audit](../AUDIT.md).
